...
Bitmap.prototype.transform = function(operation) {
  ...
  this.newFile = `./assets/baldy.${operation}.bmp`;
};
 ...
 */
const transforms = {
  greyscale: transforms.transformGrey,
  invert: transforms.transformInvert,
  blue: transforms.transformBlue,
  acid: transforms.transformAcid
};
